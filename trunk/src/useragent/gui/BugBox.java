...
import useragent.senderbehaviour.BugSender;
import content.BugContent;

public class BugBox extends JDialog implements ActionListener
{
	/**
	 * 
	 */
	...
	public BugBox(String msg, Agent agent, String dest, String snipname,
			String username)
	{
	...
	public void actionPerformed(ActionEvent actionEvent)
	{
		if (actionEvent.getSource() == jbtnOk)
		{
			...
			bc.newBug(m_snipname, m_sender, jtxaData.getText());
			BugSender bs = new BugSender(bc, m_jadeid);
			m_agent.addBehaviour(bs);
