...
public class LogoutContent
{
	...
	public void newLogout(String username)
	{
		...
		Element newLogoutMsg = m_document.createElement("logoutmsg");

		Attr UserName = m_document.createAttribute("username");
		UserName.setValue(username);
		newLogoutMsg.setAttributeNode(UserName);

		m_document.appendChild(newLogoutMsg);
	}
	...
	public void newResponse(String resp)
	{
		...
		Element newRegistrationResponse = m_document.createElement("logoutmsg");
